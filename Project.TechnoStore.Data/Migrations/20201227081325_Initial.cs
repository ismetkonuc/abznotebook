        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressLine = table.Column<string>(type: "ntext", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RealPrice = table.Column<decimal>(nullable: true),
                    UnitPrice = table.Column<decimal>(nullable: false),
                    Description = table.Column<string>(type: "ntext", nullable: true),
                    Vendor = table.Column<string>(nullable: false),
                    ProcessorVendor = table.Column<string>(nullable: true),
                    ProcessorType = table.Column<string>(nullable: true),
                    GraphicsCard = table.Column<string>(nullable: true),
                    MemoryCapacity = table.Column<string>(nullable: true),
                    DiscCapacity = table.Column<string>(nullable: true),
